...
const HeroSection = () => {
    return (
        <section
            // UPDATED: Changed 'pb-16' to 'pb-0' so the section ends exactly at the content (phone)
            className="hero-gradient pt-24 pb-0 relative overflow-hidden"
            style={{
        ...
        >
            <div className="container mx-auto px-4">
                ...
                <div className="relative max-w-7xl mx-auto">
                    {/* UPDATED: Changed 'items-start' to 'items-end' to align phone to the bottom line */}
                    <div className="flex justify-center items-end">
                        ...
                        >
                            {/* Note: If there is still a tiny gap, ensure the SVG/PNG itself 
                              doesn't have transparent padding at the bottom.
                              The class 'block' can also help remove inline-image gaps.
                            */}
                            <div className="block">
                                <ImageWithFallback
                                    src={iphoneMockup}
